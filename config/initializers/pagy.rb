...
Pagy.options[:size] = 7                 # Navigation size
...
# Note: Commented out to use Pagy's fast internal i18n (~18x faster).
# Pagy automatically uses Rails.application.config.i18n.default_locale and I18n.locale
